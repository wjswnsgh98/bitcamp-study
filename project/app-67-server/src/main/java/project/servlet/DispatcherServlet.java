...
public class DispatcherServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        controllerMap.put("/book/rent", new BookRentController());
        controllerMap.put("/book/list", new BookListController(bookDao));
        controllerMap.put("/book/add", new BookAddController(bookDao, sqlSessionFactory));
        controllerMap.put("/book/view", new BookViewController(bookDao, sqlSessionFactory));
        controllerMap.put("/book/update", new BookUpdateController(bookDao, sqlSessionFactory));
        controllerMap.put("/book/delete", new BookDeleteController(bookDao, sqlSessionFactory));
