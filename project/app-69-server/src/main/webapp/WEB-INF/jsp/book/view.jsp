...
<c:if test="${not empty book}">
    ...
    <tr><th>대여일</th> <td><fmt:formatDate value="${book.rentalDate}" pattern="yyyy-MM-dd"/></td></tr>
    <tr><th>반납일</th> <td><fmt:formatDate value="${book.returnDate}" pattern="yyyy-MM-dd"/></td></tr>
    </table>

    <div>
    <button>변경</button>
    <button type='reset'>초기화</button>
    <a href='delete?booktitle=${book.getBookTitle()}&author=${book.getAuthor()}'>삭제</a>
    <a href='rent'>목록</a>
    </div>
    </form>
</c:if>
